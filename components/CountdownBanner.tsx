...
export default function CountdownBanner({ deadline, text }: CountdownBannerProps) {
  ...
  // Don't render anything on server or if countdown expired
  ...
  return (
    <div className="sticky top-0 z-[60] bg-gradient-to-r from-orange-600 via-red-600 to-orange-600 text-white shadow-lg">
      <div className="max-w-screen-xl mx-auto px-4 py-3">
        <div className="flex items-center justify-center gap-3 md:gap-4 text-center flex-wrap">
          {/* Icon and Text */}
          ...
          <div className="flex items-center gap-2 md:gap-3">
            {/* Days */}
            <div className="flex flex-col items-center bg-white/20 rounded-lg px-2 py-1 md:px-3 md:py-1.5 backdrop-blur-sm min-w-[48px] md:min-w-[60px]">
